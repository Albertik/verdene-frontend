...
import { ItemTypes, ROWS } from './helpers';
...
class Square extends Component {
  ...
  componentDidMount() {
    ...
    roughSquare({ squareElement: this.roughSquareSvg, squareWidth: width / ROWS });
  ...
  render() {
    ...
    return connectDropTarget(
      <div
        ...
        onMouseOver={() => onMouseOverSquare(square, squareColor)}
