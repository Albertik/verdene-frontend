...
import defaultPieces from './svg/pieces/standard';
import ErrorBoundary from './ErrorBoundary';

const DraughtsboardContext = React.createContext();

const getPositionObject = position => {
  if (position === 'start')
    return fenToObj('W:W31-50:B1-20');
...
class Draughtsboard extends Component {
  static propTypes = {
    /**
     ...
     * See https://www.Draughtsboardjsx.com/basics/fen and https://www.Draughtsboardjsx.com/basics/position-object
     * for examples.
     */
     ...
     * See https://www.Draughtsboardjsx.com/custom
     * Signature: { wK:
     ...
     * when the next position comes from the position prop. See Draughtsboardjsx.com/integrations/random for an example
     */
     ...
     * 'd4': {backgroundColor: 'blue'}}.  See Draughtsboardjsx.com/integrations/move-validation for an example
     */
     ...
     * allows for customizations with rough.js. See Draughtsboardjsx.com/custom for an
     * example.
     *
     ...
     *  See Draughtsboardjsx.com/integrations/move-validation for an example.
     *
    ...
    /**
     * The logic to be performed on piece drop. See Draughtsboardjsx.com/integrations for examples.
     *
  ...
  static Consumer = DraughtsboardContext.Consumer;
...
export default DragDropContext(MultiBackend(HTML5toTouch))(Draughtsboard);